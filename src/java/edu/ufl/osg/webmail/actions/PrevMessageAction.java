 ...
 */
public class PrevMessageAction extends FolderAction {
    private static final Logger logger = Logger.getLogger(PrevMessageAction.class.getName());
    ...
    public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
        ...
        final Message prevMessage = ActionsUtil.fetchPrevMessage(message, new DateSort());
        ...
        request.setAttribute("message", prevMessage);

        // mark message as read
        prevMessage.setFlag(Flags.Flag.SEEN, true);

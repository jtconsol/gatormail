...
public class SendAction extends Action {
    ...
    public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
        ...
        message.setHeader("X-Mailer", "GatorMail WebMail (http://open-systems.ufl.edu/software/)");
        ...
        if (attachList.size() == 0) {
            ...
            final Multipart multipart = createMultipart(body, null, attachList, httpSession);
        ...
        if (compForm.isCopyToSent()) {
            ...
            final Folder sentFolder = Util.getFolder(httpSession, Constants.SENT_FOLDER_FULLNAME);
    ...
    private static Multipart createMultipart(final String body, Folder folder, final AttachList attachList, final HttpSession session) throws MessagingException, AttachDAOException {
        ...
        for (int i = 0; i < attachList.size(); i++) {
            ...
            if (attachObj.getIsForward()) {
                ...
                folder = Util.getFolder(session, folderFullName);
                // Find the message
        ...
        for (int i = 0, size = lines.size(); i < size; i++) {
            ...
            while (line != null) {
                if (line.length() < WRAP_WIDTH) {
                    ...
                    sb.append(makeQuoteDepth(quoteDepth) + line).append("\r\n");
                    line = null;
                    ...
                    sb.append(makeQuoteDepth(quoteDepth) + lineChunk).append("\r\n");

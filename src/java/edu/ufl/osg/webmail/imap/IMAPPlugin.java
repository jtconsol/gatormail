...
public class IMAPPlugin implements PlugIn {
    ...
    public IMAPPlugin() {
        ...
        // experimental custom properties - does this do anything?
        ...
        //props.setProperty("mail.imap.connectionpooltimeout", "10000");
        //props.setProperty("mail.imap.separatestoreconnection", "true");
        //props.setProperty("mail.imap.statuscachetimeout", "10000");
    }

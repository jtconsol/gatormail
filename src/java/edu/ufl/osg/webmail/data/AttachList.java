...
public final class AttachList implements List, java.io.Serializable {
    ...
    /**
     * Remove attachments from both this List and from backend storage.
     */
    public void clearAttachments() throws AttachDAOException {
        // first clear any files in backend storage
